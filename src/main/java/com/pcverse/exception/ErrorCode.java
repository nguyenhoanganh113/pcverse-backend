...
public enum ErrorCode {
    ...
    ATTRIBUTE_OPTION_DUPLICATE(409, "An attribute option code was provided more than once", HttpStatus.CONFLICT),
    ...
    CATEGORY_ATTRIBUTE_DUPLICATE(409, "An attribute definition was provided more than once", HttpStatus.CONFLICT),
